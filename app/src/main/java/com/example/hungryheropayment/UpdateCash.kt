...
class UpdateCash : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ubutton.setOnClickListener {
            val deliveryName = typeboxu1.text.toString()
            val deliveryAddress = typeboxu2.text.toString()
            val deliveryNic = typeboxu3.text.toString()
            val deliveryNumber = typeboxu4.text.toString()

            updateData(deliveryName, deliveryAddress, deliveryNic, deliveryNumber)
        }
    }

    private fun updateData(deliveryName: String, deliveryAddress: String, deliveryNic: String, deliveryNumber: String) {
        ...
        val user = mapOf<String, String>("deliveryName" to deliveryName, "deliveryAddress" to deliveryAddress, "deliveryNic" to deliveryNic, "deliveryNumber" to deliveryNumber)
        databaseReference.child(deliveryName).updateChildren(user).addOnSuccessListener {
